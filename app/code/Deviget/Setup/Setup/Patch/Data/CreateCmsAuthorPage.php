...
<style>#html-body [data-pb-style=E8B8X1K],#html-body [data-pb-style=H8ONSCT],#html-body [data-pb-style=VAG2RHB]{background-position:left top;background-size:cover;background-repeat:no-repeat;background-attachment:scroll}#html-body [data-pb-style=H8ONSCT],#html-body [data-pb-style=VAG2RHB]{justify-content:flex-start;display:flex;flex-direction:column}#html-body [data-pb-style=E8B8X1K]{align-self:stretch}#html-body [data-pb-style=T0K3DSD]{display:flex;width:100%}#html-body [data-pb-style=DDMW9FO]{justify-content:flex-start;display:flex;flex-direction:column;background-position:left top;background-size:cover;background-repeat:no-repeat;background-attachment:scroll;width:33.3333%;align-self:stretch}#html-body [data-pb-style=LUUDYNO]{border-style:none}#html-body [data-pb-style=NPQK45A],#html-body [data-pb-style=S5GJQJB]{max-width:100%;height:auto}#html-body [data-pb-style=GRCXCQ4]{justify-content:flex-start;display:flex;flex-direction:column;background-position:left top;background-size:cover;background-repeat:no-repeat;background-attachment:scroll;width:66.6667%;align-self:stretch}#html-body [data-pb-style=LPX6SVF]{margin-top:0;padding-top:0}@media only screen and (max-width: 768px) { #html-body [data-pb-style=LUUDYNO]{border-style:none} }</style><div data-content-type="row" data-appearance="contained" data-element="main"><div data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}" data-background-type="image" data-video-loop="true" data-video-play-only-visible="true" data-video-lazy-load="true" data-video-fallback-src="" data-element="inner" data-pb-style="H8ONSCT"><h1 data-content-type="heading" data-appearance="default" data-element="main">Maximiliano Ledesma</h1><h2 data-content-type="heading" data-appearance="default" data-element="main">Magento Full-stack Developer</h2></div></div><div data-content-type="row" data-appearance="contained" data-element="main"><div data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}" data-background-type="image" data-video-loop="true" data-video-play-only-visible="true" data-video-lazy-load="true" data-video-fallback-src="" data-element="inner" data-pb-style="VAG2RHB"><div class="pagebuilder-column-group" data-background-images="{}" data-content-type="column-group" data-appearance="default" data-grid-size="12" data-element="main" data-pb-style="E8B8X1K"><div class="pagebuilder-column-line" data-content-type="column-line" data-element="main" data-pb-style="T0K3DSD"><div class="pagebuilder-column" data-content-type="column" data-appearance="full-height" data-background-images="{}" data-element="main" data-pb-style="DDMW9FO"><figure data-content-type="image" data-appearance="full-width" data-element="main" data-pb-style="LUUDYNO"><img class="pagebuilder-mobile-hidden" src="{{media url=.renditions/wysiwyg/Screenshot_2023_04_05_082849.0.jpg}}" alt="" title="" data-element="desktop_image" data-pb-style="NPQK45A"><img class="pagebuilder-mobile-only" src="{{media url=.renditions/wysiwyg/Screenshot_2023_04_05_082849.0.jpg}}" alt="" title="" data-element="mobile_image" data-pb-style="S5GJQJB"></figure><h2 data-content-type="heading" data-appearance="default" data-element="main">Contact info</h2><div data-content-type="text" data-appearance="default" data-element="main"><p><strong>Email:</strong> <a tabindex="0" href="mailto:maximilianoledesma@gmail.com">maximilianoledesma@gmail.com</a></p>
...
<p>&nbsp;</p></div></div><div class="pagebuilder-column" data-content-type="column" data-appearance="full-height" data-background-images="{}" data-element="main" data-pb-style="GRCXCQ4"><h2 data-content-type="heading" data-appearance="default" data-element="main" data-pb-style="LPX6SVF">Introduction</h2><div data-content-type="text" data-appearance="default" data-element="main"><p>I'm a Magento frontend developer since 2016 and working as a fullstack developer since early 2021.&nbsp;</p>
...
<p>Currently, I'm working with Wolters Kluwer as a fronted developer.</p>
HTML;
